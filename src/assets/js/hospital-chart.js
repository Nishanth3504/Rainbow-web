...
var options = {
    ...
    stroke: {
        ...
        colors: ['#7E3A93'] // Custom color for the connecting line
    },
    markers: {
        size: 2, // Adjust the dot size
        colors: ['#7E3A93'], // Customize dot color
        strokeWidth: 0,
        strokeColors: ['#dddddd']
    },
    legend: {
...
var options = {
    ...
    colors: ['#7E3A93', '#7E3A93', '#FF5A39'], // Red for ICU, Green for Surgery, Blue for General
};
